...
?>
  ...
  <div class="card-body">
    <div class="table-wrap">
        <table class="table"> 
                <?php
                if (isset ($_POST['submit']) and isset($_POST['tgl1']) and isset($_POST['tgl2']) and isset ($_POST['jenis']) and isset ($_POST['kota']))
                 { ?>
                <?php $dt1=$_POST['tgl1'];
                  $dt2=$_POST['tgl2'];
                  $dt2=$_POST['tgl2'];
                  $jenis=$_POST['jenis'];
                  $kota=$_POST['kota'];
                  echo "<b>Informasi : </b><i> Pencarian <b>kelompok barang</b> berdasarkan $jenis </i> dari kota $kota";?>
                ...
                where tgl_rinci BETWEEN '$dt1' AND '$dt2' AND nm_kota='$kota' AND nm_jns_brg= '$jenis' GROUP BY penjual.id_penjual order by QTY desc limit 10 "; 
                ...
                <?php $nomor=1;
                    ...
                    <?php }  ?>
                 <?php } else if (isset ($_POST['submit']) and isset($_POST['tgl1']) and isset($_POST['tgl2']) and isset ($_POST['jenis']))
                 { ?>
                <?php $dt1=$_POST['tgl1'];
                  $dt2=$_POST['tgl2'];
                  $jenis=$_POST['jenis'];
                  echo "<b>Informasi : </b><i> Pencarian <b>kelompok barang</b> berdasarkan $jenis </i>";?>
                <?php $query1= "SELECT nm_pen, sum(qty_barang) AS QTY FROM transaksi LEFT JOIN barang ON transaksi.id_barang = barang.id_barang LEFT JOIN faktur_rinci ON transaksi.id_faktur_rinci=faktur_rinci.id_faktur_rinci JOIN kelompok_barang on barang.id_kelompok_barang=kelompok_barang.id_kelompok_barang JOIN jenis_barang On kelompok_barang.id_jenis=jenis_barang.id_jenis JOIN penjual on faktur_rinci.id_penjual=penjual.id_penjual JOIN kota on penjual.kota=kota.id_kota 
                where tgl_rinci BETWEEN '$dt1' AND '$dt2' AND nm_jns_brg= '$jenis' GROUP BY penjual.id_penjual order by QTY desc limit 10 "; 
                $resultt=mysqli_query($koneksi,$query1);
                $resnum = mysqli_num_rows($result1);?>
                    <thead class="thead-primary">
                <tr>
                ...
                <?php $dt1=$_POST['tgl1'];
                  $dt2=$_POST['tgl2'];
                  echo "<b>Informasi : </b><i> Pencarian <b>dari tanggal $dt1 sampai $dt2</b></i>";?>
                <?php $query1= "SELECT nm_pen, sum(qty_barang) AS QTY FROM transaksi LEFT JOIN barang ON transaksi.id_barang = barang.id_barang LEFT JOIN faktur_rinci ON transaksi.id_faktur_rinci=faktur_rinci.id_faktur_rinci JOIN kelompok_barang on barang.id_kelompok_barang=kelompok_barang.id_kelompok_barang JOIN jenis_barang On kelompok_barang.id_jenis=jenis_barang.id_jenis JOIN penjual on faktur_rinci.id_penjual=penjual.id_penjual JOIN kota on penjual.kota=kota.id_kota 
