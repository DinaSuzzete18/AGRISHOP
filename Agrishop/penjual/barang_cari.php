...
$query=mysqli_query($koneksi, "SELECT * FROM barang join penjual on barang.id_penjual=penjual.id_penjual JOIN kelompok_barang ON barang.id_kelompok_barang=kelompok_barang.id_kelompok_barang join jenis_barang on kelompok_barang.id_jenis=jenis_barang.id_jenis WHERE nm_barang LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM barang join penjual on barang.id_penjual=penjual.id_penjual JOIN kelompok_barang ON barang.id_kelompok_barang=kelompok_barang.id_kelompok_barang join jenis_barang on kelompok_barang.id_jenis=jenis_barang.id_jenis WHERE barang.nm_barang LIKE '%$keyword%'"); ?>
