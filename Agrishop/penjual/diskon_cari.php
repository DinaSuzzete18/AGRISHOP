...
$query=mysqli_query($koneksi, "SELECT * FROM diskon WHERE nm_diskon LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
            ...
            <table class="table">
              <thead class="thead-primary">
                <tr>
                  <th><b> No </b></th>
                  <th><b> Id Diskon </b></th>
                  <th><b> Nama Diskon </b></th>
                  <th><b> Harga Diskon </b></th>
                  <th><b> Tanggal Muncul </th></b>
                  <th><b> Aksi </b></th>
                </tr>
              </thead>
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM diskon WHERE nm_diskon LIKE '%$keyword%'"); ?>
