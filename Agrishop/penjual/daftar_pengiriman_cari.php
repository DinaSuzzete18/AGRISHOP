...
$query=mysqli_query($koneksi, "SELECT * FROM daftar_pengiriman WHERE id_daftar_pengiriman LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM daftar_pengiriman WHERE id_daftar_pengiriman LIKE '%$keyword%'"); ?>
    <?php while ($pecah=$ambil->fetch_assoc()){ ?>
    <tr>
                  <td> <?php echo $nomor?> </td>
                  <td> <?php echo $pecah['id_daftar_pengiriman']?> </td>
                  <td> Rp.<?php echo number_format($pecah['tarif_pengiriman']); ?> </td>
