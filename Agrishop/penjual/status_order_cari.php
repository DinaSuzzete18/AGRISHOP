...
$query=mysqli_query($koneksi, "SELECT * FROM status_order WHERE nm_status_order LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
            ...
            <table class="table">
              <thead class="thead-primary">
                <tr>
				 ...
				 <tbody>
				 <?php $nomor=1; ?>
				 <?php $ambil=$koneksi->query("SELECT * FROM status_order WHERE nm_status_order LIKE '%$keyword%'"); ?>
