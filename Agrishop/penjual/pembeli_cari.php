...
$query=mysqli_query($koneksi, "SELECT * FROM pembeli join kota on pembeli.id_kota_tujuan=kota.id_kota WHERE nm_pembeli LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
            ...
            <table class="table">
              <thead class="thead-primary">
                <tr>
				 ...
				 <tbody>
				 <?php $nomor=1; ?>
				 <?php $ambil=$koneksi->query("SELECT * FROM pembeli join kota on pembeli.id_kota_tujuan=kota.id_kota WHERE nm_pembeli LIKE '%$keyword%'"); ?>
