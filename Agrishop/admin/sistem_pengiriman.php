          ...
          <tr>
            ...
            <td><button class="btn btn-primary" name="cari"> Cari </button>
                  ...
                  <th> Aksi</th></b>
					    ...
					    <tbody>
					      <?php $nomor=1; ?>
                <?php $ambil=$koneksi->query("SELECT * FROM sistem_pengiriman JOIN jasa_kirim on sistem_pengiriman.id_jasa_kirim=jasa_kirim.id_jasa_kirim"); ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?halaman=sistem_pengiriman_hapus&id_sistem_pengiriman=<?php echo $pecah['id_sistem_pengiriman']; ?>" 
                    class="btn-danger btn"> Hapus </a>
                    <a href="index.php?halaman=sistem_pengiriman_ubah&id_sistem_pengiriman=<?php echo $pecah['id_sistem_pengiriman']; ?>" 
