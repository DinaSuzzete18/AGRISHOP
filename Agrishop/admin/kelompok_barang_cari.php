...
$query=mysqli_query($koneksi, "SELECT * FROM kelompok_barang JOIN jenis_barang ON kelompok_barang.id_jenis=jenis_barang.id_jenis WHERE nm_kelompok_barang LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM kelompok_barang JOIN jenis_barang ON kelompok_barang.id_jenis=jenis_barang.id_jenis WHERE nm_kelompok_barang LIKE '%$keyword%'"); ?>
