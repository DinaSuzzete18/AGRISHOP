...
$query=mysqli_query($koneksi, "SELECT * FROM jasa_pembayaran WHERE nm_jasa_pembayaran LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM jasa_pembayaran WHERE nm_jasa_pembayaran LIKE '%$keyword%'"); ?>
