...
$query=mysqli_query($koneksi, "SELECT * FROM jenis_barang WHERE nm_jns_brg LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM jenis_barang WHERE nm_jns_brg LIKE '%$keyword%'"); ?>
