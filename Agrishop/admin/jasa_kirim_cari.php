...
$query=mysqli_query($koneksi, "SELECT * FROM jasa_kirim WHERE nm_jasa_kirim LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <tbody>
  <?php $nomor=1; ?>
    <?php $ambil=$koneksi->query("SELECT * FROM jasa_kirim WHERE nm_jasa_kirim LIKE '%$keyword%'"); ?>
