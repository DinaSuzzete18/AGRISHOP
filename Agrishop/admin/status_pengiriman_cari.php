...
$query=mysqli_query($koneksi, "SELECT * FROM status_pengiriman WHERE nm_status_pengiriman LIKE '%$keyword%'")
?>
    <meta charset="utf-8">
  ...
  <section>
         ...
         <tbody>
         <?php $nomor=1; ?>
         <?php $ambil=$koneksi->query("SELECT * FROM status_pengiriman WHERE nm_status_pengiriman LIKE '%$keyword%'"); ?>
