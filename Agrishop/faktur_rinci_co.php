...
<?php
$ambil=$koneksi->query("SELECT * FROM faktur_rinci JOIN faktur_beli ON faktur_rinci.id_faktur_beli=faktur_beli.id_faktur_beli JOIN pembeli on faktur_beli.id_pembeli=pembeli.id_pembeli join kota on pembeli.id_kota_tujuan=kota.id_kota
...
<h5>  
ID Faktur 			: <?php echo $detail['id_faktur_rinci']; ?> <br>
Tanggal    			: <?php echo date("d F Y",strtotime($detail['tgl_rinci'])); ?> <br>
Sub Harga 		: Rp. <?php echo number_format($detail['total_bayar']); ?><br>
	</div>
	<div class="col-md-6">
