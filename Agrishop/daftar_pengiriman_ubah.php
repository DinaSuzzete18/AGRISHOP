                    ...
                    <div class="card rounded-0">
                        <h6> 
                           ...
                           ( <?php echo $pecah['nm_kategori']?>-<?php echo $pecah['nm_jasa_kirim']?> <?php echo $pecah['nm_sistem_pengiriman']?>) Rp. <?php echo $pecah['tarif_pengiriman']?> </h6>  
                                ...
                                <a class="btn btn-success text-white mt-2" name="tarif_pengiriman" href ="checkout.php?tarif_pengiriman=<?php echo $pecah['tarif_pengiriman']; ?>&id_daftar_pengiriman=<?php echo $pecah['id_daftar_pengiriman']; ?>&no=<?php echo $noj?>"><i class="fas fa-check"></i></a><th> </th>
                            </ul>
                        </div>
                    </div>
                    </div>
